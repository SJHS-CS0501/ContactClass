...
public class ContactTest {
    ...
    public static void main(String[] args) {
        ...
        do {
	        ...
	        test.setLastName(input);
        } while (!test.nameIsValid(input));
        ...
        do {
	        ...
	        input = keyboard.nextLine();
	        test.setMiddleName(input);
        } while (!test.nameIsValid(input));
        
        // Set prefix
        System.out.print("Enter the prefix: ");
        input = keyboard.nextLine();
        test.setPrefix(input);
        ...
        do {
	        ...
	        input = keyboard.nextLine();
	        test.setZip(input);
        } while (!test.zipIsValid(input));
        
        // Set occupation
        System.out.print("Enter the occupation: ");
        input = keyboard.nextLine();
        test.setOccupation(input);
        
        // Print out all entered contact information
        System.out.println("");
        ...
        System.out.println("Prefix: " + test.getPrefix());
        System.out.println("Phone number: " + test.getPhone());
        System.out.println("Email address: " + test.getEmail());
        System.out.println("Street: " + test.getStreet());
        System.out.println("City: " + test.getCity());
        System.out.println("State: " + test.getState());
        System.out.println("ZIP code: " + test.getZip());
